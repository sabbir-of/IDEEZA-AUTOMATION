...
export default class ENV {
        ...
        public static get PROJECT_CREATE(): string {
                return ENV.config.PROJECT_CREATE;
        }
        ...
        public static get ADMIN_EMAIL(): string {
                return ENV.config.ADMIN_EMAIL;
        }

        public static get ADMIN_PASSWORD(): string {
                return ENV.config.ADMIN_PASSWORD;
        }
        ...
        public static get META_URL(): string {
                return ENV.config.META_URL;
        }
